...
public class Horarios extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listaConferencistas.add(new Conferencistas("Gerardo López", "Ingeniero en Diseño Digital", "Ingeniero en Diseño Digital, maestro en educación, neurocognición, aprendizaje y desarrollo humano. Especialista en diseño y desarrollo de proyectos educativos y museografía en las áreas culturales.",8 , 9));
