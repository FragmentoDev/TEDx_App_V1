...
public class Horarios extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listaConferencistas.add(new Conferencistas("Alejandro Félix", "Empresario", "Empresario dueño y fundador de Boki sushi, marisquería cocolobampo. Presidente de grupo EMUS. Consejero de Canirac y canacintra Los Mochis",5 , 6));
        listaConferencistas.add(new Conferencistas("Miguel Renteria", "Licenciado en Economía", "Originario del estado de Sinaloa es un \"Licenciado en Economía, Derecho\" y actualmente es un asesor de asistencia legislativa para el congreso del estado de Sinaloa. Se autoconsidera un amante del planeta pues su voluntario en greenpeace sinaloa lo avala, es encargado de promover diferentes iniciativas en el congreso se Sinaloa para promover los derechos de las mujeres.",6 , 7));
        listaConferencistas.add(new Conferencistas("Ana Retamoza", "Emprendedora", "Estudiante de preparatoria. Medalla de oro en el concurso latinoamericano de computo. Embajadora de my world mexico en Sinaloa. Reconocida por la empresa latina Nerds como mujer emprendedora más sobresaliente. Primer lugar en la Feira de Ciências e Engenharia do Estado do Amapá, Brasil. Creadora de un sistema educativo basado en el desarrollo sustentable de la agenda 2030.",7 , 8));
        listaConferencistas.add(new Conferencistas("Gerardo López", "Ingeniero en Diseño Digital", "Ingeniero en Diseño Digital, mastro en educación, neurocognición, aprendizaje y desarrollo humano. Especialista en diseño y desarrollo de proyectos educativos y museografía en las áreas culturales.",8 , 9));
        listaConferencistas.add(new Conferencistas("Mariela Guadalupe", "Ingeniera Industrial", "Ingeniera industrial con especialidad en logística. Docente de universidad. Supervisora de almacenaje y logística. Emprendedora. Certificación en metrología básica de la administración de proyectos. Defensora de los derechos de la mujer y feminista.",9 , 10));
        listaConferencistas.add(new Conferencistas("Luis Escobedo", "Licenciado en Psicología", "Licenciado en psicología experto en procesos digitales, coordinador de eventos masivos, promotor cultural y marketing psicológico. Un mochitense comprometido con fomentar el arte y cultura de su ciudad de diferentes formas, creador de identidad para la ciudad y comprometido en aprovechar al máximo las infraestructuras con las que la ciudad cuenta para explotar al máximo su potencial.",10 , 11));
        listaConferencistas.add(new Conferencistas("Krishna Ramirez", "Pintora", "Es una pintora mexicana que con tan solo 19 años a logrado romper las barreras que la vida le a propuesto, una de las jóvenes promesas del arte en México, sus obras han sido galardonadas en todo el mundo en diferentes estacias como lo son en : \n" +
                "Tokyo International Photo Awards Winners en 2018. \n" +
                "The Exposure Award Collection, Museo De Louvre. \n" +
                "Por mencionar algunas de las exposiciones que ha realizado, sin mencionar la cantidad de conferencias y talleres que ha impartido en todo el mundo divulgando su arte.",11 , 12));
        listaConferencistas.add(new Conferencistas("María Stone", "Médica Cirujana", "Estudiante de preparatoria. Medalla de oro en el concurso latinoamericano de computo. Embajadora de my world mexico en Sinaloa. Reconocida por la empresa latina Nerds como mujer emprendedora más sobresaliente. Primer lugar en la Feira de Ciências e Engenharia do Estado do Amapá, Brasil. Creadora de un sistema educativo basado en el desarrollo sustentable de la agenda 2030.",12 , 13));
        listaConferencistas.add(new Conferencistas("Hector Serrano", "Ingeniero en Negocios Internacionales", "Ingeniero en Negocios Internacionales, es un sinaloense apasionado por la información y la divulgación, esto mismo lo llevó a crear Vicious. \n" +
                "Una plataforma cuyo fin es compartir información periodistica, realizando entrevistas, conferencias y contenido en redes. Además de ser inversionista en agronegocios fomentando el amor, respeto y la libertad de los individuos.",13 , 14));
        listaConferencistas.add(new Conferencistas("Gilberto Castro", "Productor Musical", "Productor musical fundador y director de Black Rooster Producciones. Promotor del arte y la cultura. Creador de conceptos como el ROCK WAR y ayudarte. Bajista en “los espanta perros” apasionado por la música y el reggae",14 , 15));
